...
/*
//Was written this way in jsFiddle, but doesn't work for our local copy..
//SOURCE: http://jsfiddle.net/agrublev/QjVq3/
...
ls.factory("$store",function($parse){
  ...
  var privateMethods = {
    /**
     * Pass any type of a string from the localStorage to be parsed so 
     * it returns a usable version (like an Object)
  ...
  var publicMethods = {
     ...
     * @returns {*} - will return whatever it is you've stored in the 
     * local storage */
